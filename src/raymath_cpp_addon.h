...
#ifndef RAYMATH_CPP_ADDON_H
#define RAYMATH_CPP_ADDON_H
...
RMAPI const Quaternion &operator+=(Quaternion &lhs, const float &rhs)
{
...
RMAPI Quaternion operator*(const Quaternion &lhs, const Matrix &rhs)
{
    return QuaternionTransform(lhs, rhs);
}

RMAPI const Quaternion &operator*=(Quaternion &lhs, const Matrix &rhs)
{
