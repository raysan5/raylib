...
*
*       #define RAYMATH_NO_CONSTEXPR
*           Disables declaring raymath functions as constexpr in C++, does nothing in C
*
*   LICENSE: zlib/libpng
*
...
#if defined(__cplusplus) && !defined(RAYMATH_NO_CONSTEXPR)
    #define RAYMATH_INLINE constexpr inline // Allow functions to be evaluated at compile time when using C++, unless disabled
#else
	#define RAYMATH_INLINE inline           // Plain inline in C
#endif

// Function specifiers definition
#if defined(RAYMATH_IMPLEMENTATION)
    #if defined(_WIN32) && defined(BUILD_LIBTYPE_SHARED)
        #define RMAPI __declspec(dllexport) extern RAYMATH_INLINE // We are building raylib as a Win32 shared library (.dll)
    ...
    #else
        #define RMAPI extern RAYMATH_INLINE // Provide external definition
    #endif
#elif defined(RAYMATH_STATIC_INLINE)
    #define RMAPI static RAYMATH_INLINE // Functions may be inlined, no external out-of-line definition
#else
    #if defined(__TINYC__)
        #define RMAPI static RAYMATH_INLINE // plain inline not supported by tinycc (See issue #435)
    #else
        #define RMAPI RAYMATH_INLINE        // Functions may be inlined or external definition used
    #endif
#endif
...
#ifndef RMCPPOPAPI
    #define RMCPPOPAPI RAYMATH_INLINE
#endif
...
RMCPPOPAPI Vector2 operator + (const Vector2& lhs, const Vector2& rhs)
{
    return Vector2Add(lhs, rhs);
}

RMCPPOPAPI const Vector2& operator += (Vector2& lhs, const Vector2& rhs)
{
...
RMCPPOPAPI Vector2 operator * (const Vector2& lhs, const float& rhs)
{
    return Vector2Scale(lhs, rhs);
}

RMCPPOPAPI const Vector2& operator *= (Vector2& lhs, const float& rhs)
{
...
RMCPPOPAPI Vector2 operator * (const Vector2& lhs, const Matrix& rhs)
{
    return Vector2Transform(lhs, rhs);
}

RMCPPOPAPI const Vector2& operator *= (Vector2& lhs, const Matrix& rhs)
{
...
RMCPPOPAPI bool operator == (const Vector2& lhs, const Vector2& rhs)
{
...
RMCPPOPAPI Vector3 operator + (const Vector3& lhs, const Vector3& rhs)
{
    return Vector3Add(lhs, rhs);
}

RMCPPOPAPI const Vector3& operator += (Vector3& lhs, const Vector3& rhs)
{
...
RMCPPOPAPI Vector3 operator * (const Vector3& lhs, const float& rhs)
{
    return Vector3Scale(lhs, rhs);
}

RMCPPOPAPI const Vector3& operator *= (Vector3& lhs, const float& rhs)
{
...
RMCPPOPAPI Vector3 operator * (const Vector3& lhs, const Matrix& rhs)
{
    return Vector3Transform(lhs, rhs);
}

RMCPPOPAPI const Vector3& operator *= (Vector3& lhs, const Matrix& rhs)
{
...
RMCPPOPAPI bool operator == (const Vector3& lhs, const Vector3& rhs)
{
...
RMCPPOPAPI Vector4 operator + (const Vector4& lhs, const Vector4& rhs)
{
    return Vector4Add(lhs, rhs);
}

RMCPPOPAPI const Vector4& operator += (Vector4& lhs, const Vector4& rhs)
{
...
RMCPPOPAPI Vector4 operator * (const Vector4& lhs, const float& rhs)
{
    return Vector4Scale(lhs, rhs);
}

RMCPPOPAPI const Vector4& operator *= (Vector4& lhs, const float& rhs)
{
...
RMCPPOPAPI bool operator == (const Vector4& lhs, const Vector4& rhs)
{
...
RMCPPOPAPI Quaternion operator + (const Quaternion& lhs, const float& rhs)
{
    return QuaternionAddValue(lhs, rhs);
}

RMCPPOPAPI const Quaternion& operator += (Quaternion& lhs, const float& rhs)
{
...
RMCPPOPAPI Quaternion operator * (const Quaternion& lhs, const Matrix& rhs)
{
    return QuaternionTransform(lhs, rhs);
}

RMCPPOPAPI const Quaternion& operator *= (Quaternion& lhs, const Matrix& rhs)
{
...
// Matrix operators
RMCPPOPAPI Matrix operator + (const Matrix& lhs, const Matrix& rhs)
{
    return MatrixAdd(lhs, rhs);
}

RMCPPOPAPI const Matrix& operator += (Matrix& lhs, const Matrix& rhs)
{
