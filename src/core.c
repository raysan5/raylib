...
static void InitTouch(void);                            // Touch initialization (including touch thread)
static void *TouchThread(void *arg);                    // RRG Touch interface reading thread
...
// based on the Calibration date referenced by tslib.
