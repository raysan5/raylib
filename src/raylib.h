...
RLAPI bool CheckCollisionPointPolygon(Vector2 point, Vector2 *vertices, int verticesCount);              // Detects if point is within a polygon dercribed by array of vertices
