...
// Font scaling metric
typedef enum {
    FONT_SIZE_METRIC_ASCENT = 0,  // Measures font size in pixels from the baseline to the ascent line
    FONT_SIZE_METRIC_EM_BOX       // Measures font size using a ratio of the font's EM size (typically 2048 pixels)
} FontSizeMetric;
...
// Font scaling metric options
RLAPI void SetFontSizeMetric(FontSizeMetric metric);                                        // Sets the global font size metric
