...
void DrawModelEx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color tint)
{
    ...
    DrawModelPro(model, matTranslation, matRotation, matScale, tint);
}

// Draw a model with pro parameters
void DrawModelPro(Model model, Matrix translation, Matrix rotation, Matrix scale, Color tint)
{
    Matrix matTransform = MatrixMultiply(MatrixMultiply(scale, rotation), translation);
...
void DrawModelWiresPro(Model model, Matrix translation, Matrix rotation, Matrix scale, Color tint)
{
    rlEnableWireMode();

    DrawModelPro(model, translation, rotation, scale, tint);
