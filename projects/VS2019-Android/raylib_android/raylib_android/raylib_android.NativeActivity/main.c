...
int main(void)
{
    ...
    int window_width = 500; //ANativeWindow_getWidth(g_Window);
    int window_height = 500; //ANativeWindow_getHeight(g_Window);

    InitWindow(window_width, window_height, "raylib [textures] example - mouse painting");
